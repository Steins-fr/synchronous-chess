...
type RequestToResponseType<Type extends RoomApiRequestTypeEnum> = {
    [RoomApiRequestTypeEnum.CREATE]: RoomApiResponseTypeEnum.CREATE,
...
type SocketPacketNotificationPayloads = ValuesOf<{
    [Type in keyof RoomSocketApiNotificationTypedData]: SocketPacketPayload<Type, RoomSocketApiNotificationTypedData[Type]>
}>;
...
const customIconsAndMatIconsHasCommonKeys: NotificationAndResponseHasCommonKeys = 'NotificationAndResponseHasNoCommonKeys';
